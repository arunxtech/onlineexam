...
class PaymentsController extends AppController
{
    ...
    public function crm_index()
    {
        ...
        $this->Paginator->settings['conditions'] = array('Payment.student_id' => $this->studentId,'Payment.type <>'=>'FRE');
    ...
    public function rest_index()
    {
        if ($this->authenticateRest($this->request->query)) {
            ...
            $this->Paginator->settings = $this->paginate;
            $this->Paginator->settings['conditions'] = array('Payment.student_id' => $this->studentId);
