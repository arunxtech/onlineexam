...
class RegistersController extends AppController
{
    ...
    public function beforeFilter()
    {
        ...
        if ($this->frontRegistration == 0) {
            return $this->redirect(array('crm' => true, 'controller' => 'Users', 'action' => 'index'));
        }
    ...
    public function rest_save()
    {
        ...
        $this->set(compact('status', 'message', 'student_id'));
        $this->set('_serialize', array('status', 'message', 'student_id'));
    }
    ...
    public function login()
    {
        ...
        if (empty($this->data['Register']['email']) == false) {
            ...
            $user = $this->Student->find('first', array('conditions' => array('Student.email' => $this->data['Register']['email'], 'Student.password' => $password)));
            if ($user != false) {
