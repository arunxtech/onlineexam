...
class DashboardsController extends AppController
{
    ...
    public function crm_index($type = "crm", $publicKey = "0", $privateKey = "0")
    {
        ...
        $todayExam = $this->Exam->getPurchasedExam("today", $this->studentId, $this->currentDateTime, $this->limit);
        $upcomingExam = $this->Exam->getPurchasedExam("upcoming", $this->studentId, $this->currentDateTime, $this->limit);
