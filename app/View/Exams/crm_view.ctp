            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><strong
                                    class="text-success"><?php echo $this->Time->format($sysDay . $dateSep . $sysMonth . $dateSep . $sysYear, $post['Exam']['start_date']); ?></strong>
                        </td>
                        <td><strong class="text-primary"><?php echo __('End Date'); ?></strong></td>
                        <td><strong
                                    class="text-success"><?php echo $this->Time->format($sysDay . $dateSep . $sysMonth . $dateSep . $sysYear, $post['Exam']['end_date']); ?></strong>
                        </td>
                    </tr>
                    <tr>
                        <td><strong class="text-primary"><?php echo __('Negative Marking'); ?></strong></td>
                        <td><strong class="text-success"><?php echo __($post['Exam']['negative_marking']); ?></strong>
                        </td>
                        <td><strong class="text-primary"><?php if ($totalMarks > 0) echo __("Total Marks"); ?></strong>
                        </td>
                    ...
                    <?php if ($post['Exam']['paid_exam'] == 1) { ?>
                        ...
                        <td colspan="3"><strong
                                    class="text-warning"><?php echo $currency . $post['Exam']['amount']; ?></strong>
                        </td>
                        </tr><?php } ?>
                </table>
                <table class="table">
                    ...
                    <?php if ($showType == 'today' || $showType == 'purchased') { ?>
                        <tr>
                        <td colspan="4">
                            <?php echo $this->Form->button('<span class="fa fa-sign-in"></span> ' . __('Attempt Now'), array('onclick' => "javascript:showpop_up('" . $this->Html->url(array('controller' => 'Exams', 'action' => 'guidelines', $id)) . "')", 'data-toggle' => 'tooltip', 'title' => __('Attempt Now'), 'escape' => false, 'class' => 'btn btn-success')); ?>
                        </td>
                        </tr><?php } ?>
                </table>
            </div>
