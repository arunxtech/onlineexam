                ...
                <div class="exam-panel <?php echo $subjectSection; ?>" id="quespanel<?php echo $quesNo; ?>">
                    ...
                    <div class="exam-QuestionHeader">
                        ...
                        <div class="exam-ViewIn"><?php echo __('View In'); ?>
                            :<?php echo $this->Form->select('lang', $langArr, array('empty' => false, 'class' => 'examLang', 'onchange' => "changeLang(this.value,$languageCount)")); ?></div>
                    </div>
                    ...
                    <div class="exam-QuestionFooter">
                        <div class="exam-MarkForReview">
                            ...
                            <?php if ($userExamQuestion['Exam']['instant_result'] == 1) {
                                echo $this->Html->link(__('Instant Result'), array(), array('class' => "exam-SecondaryButton exam-review"));
                            } ?>
                        </div>
                        <?php if ($maxQuestionCount > 0) {
                            ?>
                            <a class="exam-DefaultButton exam-savenext"
                               onclick="callNext(<?php echo $quesNo; ?>);"><?php echo __('Next'); ?></a>
                        <?php } ?>
                        <a class="exam-DefaultButton exam-savenext"
