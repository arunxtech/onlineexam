    ...
    <div class="col-md-12 my-result" style="padding: 10px;">
        <ul class="nav nav-tabs">
            <?php if ($examDetails['Exam']['declare_result'] == "Yes") { ?>
                <li class="active"><a href="#solution" data-toggle="tab"><?php echo __('SOLUTION'); ?></a>
                </li><?php } ?>
            ...
            <div class="tab-pane active" id="solution">
                ...
                <div class="col-sm-12">
                    ...
                    <?php if ($quesNo_b[0] != $quesNo) {
                        ?>
                        <div class="col-sm-2">
                            <?php echo $this->Form->button('&larr;' . __('Prev'), array('type' => 'button', 'onclick' => "callPrev($quesSerial);", 'class' => 'btn btn-default btn-sm btn-block', 'escape' => false)); ?>
                        </div>
                    <?php }
                    if ($quesNo_b[$i - 1] != $quesNo) {
                        ?>
                        <div class="col-sm-2">
                            <?php echo $this->Form->button(__('Next') . '&rarr;', array('type' => 'button', 'onclick' => "callNext($quesSerial);", 'class' => 'btn btn-default btn-sm btn-block', 'escape' => false)); ?>
                        </div>
                    <?php } ?>
                    <div class="col-sm-3">
