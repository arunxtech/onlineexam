...
<?php if (strlen($testId) > 0) {
    echo $this->Form->button('<i class="fa fa-check-circle"></i>&nbsp; ' . __('Click here to complete %s', $remExamName), array('onclick' => "javascript:showpop_up('" . $this->Html->url(array('controller' => 'Exams', 'action' => 'start', $testId)) . "')", 'class' => 'btn btn-success', 'escape' => false)); ?>
    <p>&nbsp;</p><?php } ?>
<div class="row">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-body"><h3><?php echo __('Paid Exam'); ?> (<strong><span
                                class="text-info"><?php echo __('Top'); ?><?php echo $limit; ?></span></strong>)</h3>
                <div class="table-responsive">
