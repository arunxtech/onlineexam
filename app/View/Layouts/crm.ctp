...
<head>
    ...
    //echo $this->Html->css('/materialize/materialize');
    // echo $this->Html->css('/materialize/style');
                ...
                <?php if ($this->Session->check('Student')) { ?>
                    <ul class="nav navbar-nav navbar-right" style="color: #000;">
                        ...
                        <li class="btn-menu-toggle">
                            <div id="menu-toggle" class="show-collapsed hamburger-menu"><i class="fa fa-bars"></i></div>
                        </li>
