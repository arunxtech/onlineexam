                ...
                <div class="col-sm-9">
                    ...
                    <div class="checkouttable">
                        <div id="review_order">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-xs-12">
                                                    ...
                                                    <div>
                                                        ...
                                                        <strong><?php echo __('Qty'); ?>: </strong><label style="background-color:#eee"
                                                               class=""><?php echo $product['Package']['count']; ?></label>
                                                    </div>
                                                    <div><strong style="font-size:17px;"><?php echo __('Amount'); ?><?php if ($product['Package']['show_amount'] != $product['Package']['amount']) { ?>
                                                                <strike><span
                                                    ...
                                                    <div><p align="justify"><?php echo $product['Package']['description']; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <div class="checkout-proceed col-sm-12 col-xs-12">
                    ...
                    <div class="cart-summerymain">
                        ...
                        <?php if ($totalAmount >= 0) { ?>
                            <div class="cart-summary">
                                ...
                                <div class="col-sm-3 mamount"><span
                                ...
                                <div class="col-sm-9 total" style="padding-left:0"><b><?php echo __('Total'); ?></b>
                                </div>
