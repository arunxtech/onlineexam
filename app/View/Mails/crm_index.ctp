                        ...
                        <ul class="sidebar-list-info list-unstyled">
                            <li class="mbm" style="padding: 0px !important; margin-bottom:10px">
                                <div class="sidebar-title">
                                    ...
                                    <?php } else {
                                        echo $this->Html->link(__('Compose'), array('controller' => 'Mails', 'action' => 'compose'), array('class' => 'btn btn-danger pll prl'));
                                    }
                                    ?>
                                </div>
                            </li>
                            <li <?php if ($urlAction == "index") {
                                ...
                                <?php echo $this->Html->link(__('Inbox') . "($totalInbox)", array('controller' => 'Mails', 'action' => 'index'), array('class' => 'btn-group dropup btn-block')); ?>
                            </li>
                            <?php
                            if ($app != 'app') { ?>
                                <li <?php if ($urlAction == "sent") {
                                    ...
                                    <?php echo $this->Html->link(__('Sent Mail'), array('controller' => 'Mails', 'action' => 'sent'), array('class' => 'btn-group dropup btn-block')); ?>
                                </li>
                                <li <?php if ($urlAction == "trash") {
                                    echo "class=\"active\"";
                                } ?>>
                                    <?php echo $this->Html->link(__('Trash'), array('controller' => 'Mails', 'action' => 'trash'), array('class' => 'btn-group dropup btn-block')); ?>
                                </li>
                            <?php }
                            ?>
