    ...
    <div class="row">
        <div class="col-md-12 mrg">
            <div class="panel panel-default">
                ...
                <?php echo $this->Form->create('Installer', array('url' => array('controller' => 'Installers', 'action' => 'step2'), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Database Name'); ?></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Database User'); ?></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Database Password'); ?></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                    ...
                    <label for="inputPassword3"
                           class="col-sm-2 control-label"><?php echo __('Database Type'); ?></label>
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="radio-inline">
                                <?php echo $this->Form->radio('dbtype', array('Mysql' => 'Mysql'), array('value' => 'Mysql', 'id' => 'qtype_id', 'legend' => false, 'hiddenField' => false, 'separator' => '</div><div class="radio-inline">',
