    ...
    <div class="row">
        <div class="col-md-12 mrg">
            <div class="panel panel-default">
                ...
                <?php echo $this->Form->create('Installer', array('url' => array('controller' => 'Installers', 'action' => 'step3'), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Meta Title'); ?></label>
                        <div class="col-sm-10">
                            <?php echo $this->Form->input('meta_title', array('required' => true, 'class' => 'form-control', 'label' => false, 'placeholder' => __('Title for Site'))); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Time Zone'); ?></label>
                        <div class="col-sm-10">
                            <?php echo $this->Form->select('timezone', $this->Time->listTimezones(), array('empty' => __('Please Select Time zone'), 'required' => true, 'class' => 'form-control', 'label' => false, 'placeholder' => __('Time Zone'))); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Organization Name'); ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Organization Email'); ?></label>
                        <div class="col-sm-10">
