<div class="col-sm-12"><?php if (strlen($frontLogo) > 0) { ?><?php echo $this->Html->image($frontLogo, array('alt' => $siteName, 'class' => 'img-responsive'));
...
<div class="row my-result">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <div class="rtest_heading">
                <strong><?php echo __('Score Card For %s', h($examDetails['Exam']['name'])); ?></strong></div>
            <table class="table">
                <tr>
                    ...
                    <td><strong class="text-primary"><?php echo $examDetails['Result']['obtained_marks']; ?></strong>
                    </td>
                ...
                <tr>
                    ...
                    <td><strong class="text-primary"><?php echo $examDetails['Result']['total_question']; ?></strong>
                    </td>
                    <td><?php echo __('Total Answered Question in Test'); ?></td>
                    <td><strong class="text-primary"><?php echo $examDetails['Result']['total_answered']; ?></strong>
                    </td>
            ...
            <div class="col-sm-6">
                <div class="rtest_heading">
                    <strong><?php echo __('Performance Report For %s', h($examDetails['Exam']['name'])); ?></strong>
                </div>
                <div class="chart">
            ...
            <div class="col-sm-6">
                <div class="rtest_heading">
                    <strong><?php echo __('Question & Marks Wise Report For %s', h($examDetails['Exam']['name'])); ?></strong>
                </div>
                <div class="chart">
        ...
        <div class="tab-pane" id="subject-report">
            <div class="rtest_heading">
                <strong><?php echo __('Subject Report For %s', h($examDetails['Exam']['name'])); ?></strong></div>
            <table class="table table-striped">
                ...
                <?php foreach ($userMarksheet as $userValue): ?>
                    <tr>
                        ...
                        <td><span class="text-success"><?php echo $userValue['Subject']['marks_scored']; ?></span>/<span
            ...
            <div class="rtest_heading">
                <strong><?php echo __('Graphical Report For %s', h($examDetails['Exam']['name'])); ?></strong></div>
        ...
        <div class="tab-pane" id="time-management">
            <div class="rtest_heading">
                <strong><?php echo __('Time Management For %s', h($examDetails['Exam']['name'])); ?></strong></div>
            <table class="table table-striped">
                <tr>
                    <th><?php echo __('Name'); ?></th>
                    <th><?php echo __('Total Questions'); ?></th>
        ...
        <div class="tab-pane" id="question">
            <div class="rtest_heading">
                <strong><?php echo __('Question Report For %s', h($examDetails['Exam']['name'])); ?></strong></div>
        ...
        <div class="tab-pane" id="solution">
            <div class="rtest_heading">
                <strong><?php echo __('Solution For %s', h($examDetails['Exam']['name'])); ?></strong></div>
            <div class="col-sm-12">
                <?php foreach ($post as $k => $ques):$quesNo = $ques['ExamStat']['ques_no']; ?>
                    <div class="exam-panel" id="quespanel<?php echo $quesNo; ?>">
                        <table class="table table-bordered">
                            ...
                            <tr class="<?php echo $quesStatus; ?>">
                            <tr>
                                <td colspan="3"><?php echo '<strong>' . __('Question') . ': ' . $quesNo . '</strong>&nbsp;&nbsp;' . str_replace("<script", "", $ques['Question']['question']); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    <?php
                            ...
                            <tr>
                                ...
                                <?php if ($ques['ExamStat']['ques_status'] == 'W') { ?>
                                    ...
                                    <td><strong><?php echo __('Your Answers'); ?> :</strong>&nbsp;<strong
                                            class="text-danger"><?php echo __($userAnswer); ?></strong>
                                    <?php if ($ques['Question']['Qtype']['type'] != "S") { ?>
                                        <strong><?php echo __('Correct Answer'); ?> :</strong>&nbsp;<strong
                                                class="text-success"><?php echo __($correctAnswer); ?></strong><?php } ?>
                                    </td><?php } else { ?>
                                    <?php if ($ques['Question']['Qtype']['type'] != "S") { ?>
                                        <td><strong><?php echo __('Correct Answer'); ?> :</strong>&nbsp;<strong
                                                class="text-success"><?php echo __($correctAnswer); ?></strong>
                                        </td><?php }
                                } ?>

                            </tr>
                            <tr>
                                <td><strong><?php echo __('Max Marks'); ?>
                                        :</strong>&nbsp;&nbsp;<?php echo $ques['ExamStat']['marks']; ?></td>
                                <td><strong><?php echo __('Marks Scored'); ?>
                                        :</strong>&nbsp;&nbsp;<?php echo $ques['ExamStat']['marks_obtained']; ?></td>
                                <td><strong><?php echo __('Time Taken'); ?>
    ...
    <div class="tab-pane" id="compare-report">
        <div class="rtest_heading">
            <strong><?php echo __('Compare Report For %s', h($examDetails['Exam']['name'])); ?></strong></div>
                ...
                <div id="comppanel<?php echo $k; ?>" class="compare">
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <table class="table">
                            ...
                            <tr>
                                <td><?php echo __('Attempted Ques.'); ?></td>
                                <td><strong class="text-success"><?php echo $compPost['attempted_question']; ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo __('Unattempted Ques.'); ?></td>
                            ...
                            <tr>
                                <td><?php echo __('Correct Ques.'); ?></td>
                                <td><strong class="text-success"><?php echo $compPost['correct_question']; ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo __('Incorrect Ques.'); ?></td>
                                <td><strong class="text-danger"><?php echo $compPost['incorrect_question']; ?></strong>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <table class="table">
                            <tr>
                                <td><?php echo __('Total Score'); ?></td>
                                <td><strong class="text-primary"><?php echo $compPost[0]['Result']['obtained_marks']; ?>
                            ...
                            <tr>
                                <td><?php echo __('Percentile'); ?></td>
                                <td><strong><?php echo CakeNumber::toPercentage($compPost['percentile']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo __('Total Time'); ?></td>
