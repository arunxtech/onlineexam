...
<div class="row my-result">
    <div class="col-md-12" style="padding: 0;">
                ...
                <div class="col-sm-9">
                            ...
                            <table id="cart" class="table table-condensed">
                                    ...
                                    <td colspan="3">
                                        ...
                                        if ($ques['Qtype']['type'] == "M") {
                                            ...
                                            foreach ($options as $opt => $option):$optionSerial++;
                                                ...
                                                echo '<p><span class="optionSerial">' . $optionSerial . '. ' . $option . '</span>.' . $incorrectImg . $correctImg . '</p>';
                                            endforeach;
                                            unset($option);
                                        }
                                        if ($ques['Qtype']['type'] == "T") {
                                ...
                                <tr>
                                    <td style="margin: 0;padding-top: 0;    padding-bottom: 0;line-height: 0;">
                                        ...
                                        <?php if ($ques['ExamStat']['ques_status'] == NULL && !$ques['ExamStat']['answer']) echo '<div style="border: 1px solid;padding: 15px 15px;width: 100%;"><strong class="">' . __('Not Attempt') . '</strong></div>'; else echo '<div style="border: 1px solid;padding: 15px 15px;width: 100%;"><span class="">' . __('Attempt') . '</span></div>'; ?></strong>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div style="float: right;border-right: 1px solid;padding: 5px 15px;width: 50%;border-top: 1px solid;border-bottom: 1px solid;">
                                            <?php if ($ques['Qtype']['type'] != "S") { ?><?php echo __('Correct Answer'); ?>
                                                <br><?php echo __($correctAnswer); ?></strong><?php } ?></div>
                                    </td>
                        </div>
                        <?php } else { ?>
                    ...
                    <div style="padding-bottom: 60px;">
                        <div class="col-sm-2" style="float: right;;">
                            <?php echo $this->Form->button(__('Next') . '&rarr;', array('type' => 'button', 'onclick' => "callNext($quesNo);", 'class' => 'btn btn-default btn-sm btn-block', 'style' => 'background: #FF4081;height: 34px;width: 110px;box-shadow: 1px 2px 3px #888888;color: #fff;border: none;', 'escape' => false)); ?>
                        </div>
                        <div class="col-sm-2" style="float: right;;">
                            <?php echo $this->Form->button('&larr;' . __('Prev'), array('type' => 'button', 'onclick' => "callPrev($quesNo);", 'class' => 'btn btn-default btn-sm btn-block', 'style' => 'background: #FF4081;height: 34px;width: 110px;box-shadow: 1px 2px 3px #888888;color: #fff;border: none;', 'escape' => false)); ?>
                        </div>
                    </div>
        ...
        <?php } ?>
        <div class="tab-pane active" id="compare-report">
            <div class="com-md-12 col-sm-12 col-xs-12">
                <div style="margin-top: 10px;box-shadow: 0px 2px 5px #888888;">


                    <h4 class="panel-title"><a data-toggle="collapse"
                                               data-parent="#accordion"><strong><?php echo __('Compare Report For'); ?>  </strong><?php echo h($examDetails['Exam']['name']); ?>
                        </a></h4>
