...
class Result extends AppModel
{
    ...
    public function examOptions($serGroupWiseId)
    {
        ...
        , 'fields' => array('id', 'name'),
            'conditions' => array('Exam.status' => 'Active', "ExamGroup.group_id IN($serGroupWiseId)"),
    ...
    public function studentWise($userGroupWiseId, $name = null, $studentGroup = null)
    {
        ...
        $conditions = array();
        $conditions[] = array("StudentGroup.group_id IN($userGroupWiseId)");
        if ($name != null)
        ...
        $studentDetail = $Student->find('all', array('fields' => array('DISTINCT(Student.id)', 'Student.name', 'Student.enroll', 'Student.email'),
            'joins' => array(array('table' => 'student_groups', 'alias' => 'StudentGroup', 'type' => 'inner',
                'conditions' => array('Student.id=StudentGroup.student_id', "StudentGroup.group_id IN($userGroupWiseId)")),
    ...
    public function examWise($userGroupWiseId, $name = null, $examGroup = null, $status = null)
    {
        ...
        $conditions = array();
        $conditions[] = array("ExamGroup.group_id IN($userGroupWiseId)");
        if ($name != null)
