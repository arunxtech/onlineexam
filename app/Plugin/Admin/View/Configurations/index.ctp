<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Configuration Options'); ?></h1></div>
</div>
<div class="panel">
    <div class="panel-body"><?php echo $this->Session->flash(); ?>
        <?php echo $this->Form->create('Configuration', array('url' => array('action' => 'index'), 'type' => 'post', 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
        ...
        <div class="form-group">
            <label for="site_name" class="col-sm-2 control-label"><?php echo __('Meta Content'); ?></label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <?php echo $this->Form->select('currency', $currencyArr, array('empty' => false, 'label' => false, 'class' => 'form-control', 'div' => false, 'escape' => false)); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="site_name" class="col-sm-2 control-label"><?php echo __('PoweredBy Name'); ?></label>
            <div class="col-sm-4">
                <?php echo $this->Form->input('powerdby', array('label' => false, 'class' => 'form-control', 'placeholder' => __('PoweredBy Name'), 'div' => false)); ?>
            </div>
            <label for="site_name" class="col-sm-2 control-label"><?php echo __('PoweredBy Link'); ?></label>
            <div class="col-sm-4">
                <?php echo $this->Form->input('powerdlink', array('label' => false, 'class' => 'form-control', 'placeholder' => __('PoweredBy Link'), 'div' => false)); ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <label for="site_name"
                   class="col-sm-6 control-label"><?php echo __('Date, Month, Year, Hour, Min, Sec, Meridian, Date Separator, Time Separator'); ?></label>
        </div>
        <div class="form-group">
            <label for="group_name" class="col-sm-2 control-label">
                <small><?php echo __('Capthca'); ?></small>
            </label>
            <div class="col-sm-4">
            ...
            <label for="group_name" class="col-sm-2 control-label">
                <small><?php echo __('Text Direction'); ?></small>
            </label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label for="site_name" class="col-sm-3 control-label"><?php echo __('Tolerance Count'); ?></label>
            <div class="col-sm-1">
                <?php echo $this->Form->input('tolrance_count', array('label' => false, 'class' => 'form-control', 'div' => false)); ?>
            </div>
            <label for="site_name" class="col-sm-3 control-label"><?php echo __('Show Free Package'); ?></label>
            <div class="col-sm-1">
                <?php echo $this->Form->checkbox('free_package', array('label' => false, 'class' => 'form-control', 'div' => false)); ?>
            </div>
        </div>
        <div class="form-group">
