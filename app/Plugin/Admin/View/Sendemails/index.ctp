...
<div class="panel panel-custom">
    ...
    <div class="panel-body">
        ...
        <div class="form-group" id="any">
            ...
            <div class="col-sm-10">
                <?php echo $this->Form->input('any_email', array('type' => 'text', 'placeholder' => __('Type any email comma separated'), 'label' => false, 'class' => 'form-control', 'div' => false)); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group text-left">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-success"><span
                            class="fa fa-send"></span>&nbsp;<?php echo __('Send'); ?></button>
