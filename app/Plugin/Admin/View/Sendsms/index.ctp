    ...
    <div class="panel-body">
        ...
        <div id="students">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->select('Group.group_name', $group_id, array('multiple' => true, 'label' => false, 'class' => 'form-control multiselectgrp', 'placeholder' => __('Student Group'), 'div' => false)); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
        ...
        <div class="form-group" id="any">
            ...
            <div class="col-sm-10">
                <?php echo $this->Form->input('any_sms', array('type' => 'text', 'placeholder' => __('Type any number comma separated'), 'label' => false, 'class' => 'form-control', 'div' => false)); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group text-left">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-success"><span
                            class="fa fa-mobile"></span>&nbsp;<?php echo __('Send'); ?></button>
