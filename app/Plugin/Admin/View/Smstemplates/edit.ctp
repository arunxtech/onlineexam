<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit SMS templates'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            <div class="panel-body">
                ...
                <?php foreach ($Smstemplate as $k => $post): $id = $post['Smstemplate']['id'];
                    $form_no = $k + 1; ?>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="group_name" class="col-sm-4 control-label">
                                    <small><?php echo __('Template'); ?>:</small>
                                </label>
                                <div class="col-sm-6">
