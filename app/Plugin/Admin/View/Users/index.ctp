...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Users'); ?></h1></div>
    </div>
    <div class="panel">
        <?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Users'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New User'), array('controller' => 'Users', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-success')); ?>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($User as $post):
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="label label-<?php if ($post['User']['status'] == "Active") echo "success"; else echo "danger"; ?>"><?php echo __($post['User']['status']); ?></span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <?php if ($id != 1){ ?>
                                        <li><?php echo $this->Html->Link('<span class="fa fa-trash"></span>&nbsp;' . __('Delete'), 'javascript:void(0);', array('onclick' => "check_perform_sdelete('$id');", 'escape' => false));
                                            } ?></li>
                                    </ul>
                                </div>
                            </td>
