<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Class'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Group as $k => $post): $id = $post['Group']['id'];
                $form_no = $k + 1; ?>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-3 control-label"><?php echo __('Class Name'); ?></label>
                            <div class="col-sm-9">
                                <?php echo $this->Form->input("$k.Group.group_name", array('label' => false, 'class' => 'form-control', 'placeholder' => __('Class Name'), 'div' => false)); ?>
                            </div>
                        </div>
