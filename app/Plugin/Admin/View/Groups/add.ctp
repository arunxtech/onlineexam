<div class="panel panel-custom">
    <div class="panel-heading"><?php echo __('Add Class'); ?></div>
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php echo $this->Form->input('group_name', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Class Name'), 'div' => false)); ?>
            </div>
        </div>
