...
<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Students'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Student as $k => $post): $id = $post['Student']['id'];
                $form_no = $k + 1; ?>
                <div class="panel panel-default">
                    <div class="panel-heading"><strong class="text-danger">
                            <small><?php echo __('Form'); ?><?php echo $form_no ?></small>
                        </strong></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group">
                                <label for="email" class="col-sm-2 control-label">
                                    <small><?php echo __('Email'); ?><span class="text-danger"> *</span></small>
                                </label>
                                <div class="col-sm-4">
                                ...
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Class'); ?><span class="text-danger"> *</span></small>
                                </label>
                                <div class="col-sm-4">
                                    <?php $gp2 = array();
                                    ...
                                    <?php endforeach;
                                    unset($groupName); ?>
                                    <?php echo $this->Form->select("$k.StudentGroup.group_name", $group_id, array('value' => $gp2, 'multiple' => true, 'label' => false, 'class' => 'form-control multiselectgrp', 'div' => false));
                                    $gp2 = array(); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Name'); ?><span class="text-danger"> *</span></small>
                                </label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Address'); ?><span class="text-danger"> *</span></small>
                                </label>
                                <div class="col-sm-4">
                                    <?php echo $this->Form->input("$k.Student.address", array('label' => false, 'class' => 'form-control', 'placeholder' => __('Address'), 'div' => false)); ?>
                                </div>
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Phone'); ?><span class="text-danger"> *</span></small>
                                </label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php echo $this->Form->input("$k.Student.guardian_phone", array('label' => false, 'class' => 'form-control', 'placeholder' => __('Alternate Number'), 'div' => false)); ?>
                                </div>
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Enrolment Number'); ?></small>
                                </label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Expiry Days'); ?> (<?php echo __('0 for Unlimited'); ?>)
                                    </small>
                                </label>
                                <div class="col-sm-4">
                                ...
                                <label for="group_name" class="col-sm-2 control-label">
                                    <small><?php echo __('Renewal Date'); ?></small>
                                </label>
                                <div class="col-sm-4">
