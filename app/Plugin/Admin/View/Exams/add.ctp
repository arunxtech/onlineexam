    ...
    <div class="panel">
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <div class="form-group">
                ...
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Select Class'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->select('ExamGroup.group_name', $group_id, array('multiple' => true, 'label' => false, 'class' => 'form-control multiselectgrp', 'placeholder' => __('Student Class'), 'div' => false)); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Multi Langyage'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('multi_language', array('type' => 'radio', 'options' => array("1" => __('Yes'), "0" => __('No')), 'default' => '1', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
            </div>
            <div id="showExam">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div><label for="group_name" class="col-sm-2 control-label">
                            <small><?php echo __('Ques Attempt Count'); ?></small>
                        </label></div>
                    <div><label for="group_name" class="col-sm-2 control-label">
                    ...
                    <form name="modalForm" id="modalForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-4 control-label"><?php echo __('Questions Attempt Count'); ?>:</label>
                            <div class="col-sm-8">
