                            ...
                            <td class="pbutton">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><?php echo $this->Html->link('<span class="fa fa-arrows-alt"></span>&nbsp;' . __('View Questions'), array('controller' => 'Addquestions', 'action' => "viewQuestion/$id"), array('escape' => false)); ?></li>
