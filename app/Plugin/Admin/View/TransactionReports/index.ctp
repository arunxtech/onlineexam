    ...
    <div class="panel">
        ...
        <div class="panel-heading">
            ...
            <div class="row mrg">
                ...
                <div class="col-sm-3">
                    <?php echo $this->Form->select('payment_mode', array('ADM' => __('ADMINISTRATOR'), 'CAE' => __('CC AVENUE'), 'FRE' => __('FREE'), 'PME' => __('PAYU MONEY')), array('empty' => false, 'multiple' => true, 'class' => 'form-control multiselectgrp', 'div' => false, 'label' => false)); ?>
                </div>
                <div class="col-sm-2">
