            ...
            <?php foreach ($Attemptedpapers as $post): ?>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="widget">
                            <h4 class="widget-title"><?php echo __('Attempted Papers of'); ?>
                                <span><?php echo $post['Exam']['name']; ?></span></h4>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo $post['Attemptedpaper']['obtained_marks'];
                                    echo ($post['Attemptedpaper']['user_id'] == 0) ? __('Pending') : ""; ?></td>
                            </tr>
                            <tr>
                                <td><?php echo __('Result Finalized'); ?></td>
                                <td><?php $examResultId = $post['Attemptedpaper']['id'];
                                    if ($post['Attemptedpaper']['user_id'] == 0) {
                                        echo $this->Form->postLink(__('Finalize It'), array('action' => 'finalize', $examId, $page, $examResultId), array('confirm' => 'Are you sure, you want to finalize this paper', 'class' => 'btn btn-success'));
                                    } else {
                                        ?><span
                                        class="label label-<?php if ($post['Attemptedpaper']['result'] == "Pass") echo "success"; else echo "danger"; ?>"><?php if ($post['Attemptedpaper']['result'] == "Pass") {
                                            echo __('PASSED');
                                        } else {
                                            echo __('FAILED');
                                        } ?></span><?php } ?></td>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse"
                                               href="#collapse<?php echo $ques['ExamStat']['ques_no']; ?>">
                                                <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "M"){ ?>
                                                <span class="<?php echo($ques['ExamStat']['option_selected'] == $ques['ExamStat']['correct_answer'] ? "text-success" : "text-danger"); ?>"><?php } ?>
                                                    <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "T"){ ?>
                                                    <span class="<?php echo($ques['ExamStat']['true_false'] == $ques['ExamStat']['correct_answer'] ? "text-success" : "text-danger"); ?>"><?php } ?>
                                                        <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "F"){ ?>
                                                        <span class="<?php echo($ques['ExamStat']['fill_blank'] == $ques['ExamStat']['correct_answer'] ? "text-success" : "text-danger"); ?>"><?php } ?>
                                                            <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "S"){ ?>
                                                            <span class="text-info"><?php } ?>
                                                                <strong><?php echo __('Question No'); ?>
                                                                    .<?php echo $ques['ExamStat']['ques_no']; ?>
                                                                    &nbsp;(<?php echo $Qtype[$ques['qtype_id'] - 1]['Qtype']['question_type']; ?>
                                                                    )</strong></span>
                                            </a>
                                        </div>
                                        <div id="collapse<?php echo $ques['ExamStat']['ques_no']; ?>"
                                             class="collapse<?php echo ($k == 0) ? "in" : ""; ?>">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "M") { ?>
                                                        <?php if (strlen($ques['option1']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option1'); ?></strong>
                                                                </td>
                                                        ...
                                                        <?php if (strlen($ques['option2']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option2'); ?> </strong>
                                                                </td>
                                                        ...
                                                        <?php if (strlen($ques['option3']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option3'); ?></strong>
                                                                </td>
                                                        ...
                                                        <?php if (strlen($ques['option4']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option4'); ?></strong>
                                                                </td>
                                                        ...
                                                        <?php if (strlen($ques['option5']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option5'); ?></strong>
                                                                </td>
                                                        ...
                                                        <?php if (strlen($ques['option6']) > 0) { ?>
                                                            <tr class="text-left">
                                                                <td>
                                                                    <strong class="text-warning"><?php echo __('Option6'); ?></strong>
                                                                </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2"><?php echo __('Marked Answer'); ?>
                                                            : <?php echo h($userAnswer); ?></td>
                                                        <td colspan="2"><span
                                                                    class="text-success"><?php echo __('Correct Answer'); ?>
                                                                : <?php echo h($correctAnswer); ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo __('Time Taken'); ?>
                                                            : <?php echo $this->Function->secondsToWords($ques[0]['time_taken'], "Not Attempted"); ?></td>
                                                        <td><?php echo __('Marks'); ?>
                                                            : <?php echo $ques['ExamStat']['marks']; ?></td>
                                                        <td><?php echo __('Marks Obtained'); ?>
                                                            : <?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "S" && $post['Attemptedpaper']['user_id'] == 0) {
                                                                $id = $ques['ExamStat']['exam_id'];
                                                                $statId = $ques['ExamStat']['id'];
                                                                echo $this->Form->create('Attemptedpaper', array('url' => array('action' => "marksupdate", $id, $statId), 'name' => 'post_req', 'id' => 'post_req', 'inputDefaults' => array('label' => false, 'div' => false)));
                                                        ...
                                                        <td><?php echo __('Checked by'); ?>
                                                            : <?php echo ($ques['ExamStat']['user_id'] == 0) ? __('System') : h($userName); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                            <hr/>
