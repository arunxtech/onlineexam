...
<div id="resultDiv">
    ...
    <div class="panel">
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <div class="row mrg">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php echo $this->Html->link('<span class="fa fa-refresh"></span>&nbsp;' . __('Reset'), array('controller' => 'Addquestions', 'action' => 'viewQuestion', $exam_id), array('class' => 'btn btn-warning', 'escape' => false)); ?>
                    </div>
                </div>
            ...
            <?php echo $this->element('pagination', array('IsAction' => 'viewQuestion', 'IsSearch' => 'No'));
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <?php foreach ($Addquestion as $post):
                            ...
                            <tr>
                                ...
                                <td><?php echo h($post['Topic']['name']); ?></td>
                                <td><?php echo h($post['Stopic']['name']); ?></td>
