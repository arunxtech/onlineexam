            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="widget">
                        <h4 class="widget-title">
                            <span><?php echo __('Assessment Report for'); ?><?php echo h($examDetails['Exam']['name']); ?></span>
                        </h4>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>
                                <strong class="text-danger"><?php echo __('Nos. of Browser tolerance attempt'); ?></strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="label label-<?php if ($examDetails['ExamResult']['result'] == "Pass") echo "success"; else echo "danger"; ?>"><?php if ($examDetails['ExamResult']['result'] == "Pass") {
                                        echo __('PASSED');
                                    } else {
                                        echo __('FAILED');
                                    } ?></span></td>
            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <td>
                                <div style="margin:5px;height:15px;width:15px;background-color:#0d233a;" ;>&nbsp;</div>
                            </td>
                            <td><strong><?php echo __('Maximum Score'); ?></strong></td>
                        </tr>
                        <tr>
                            <td>
                                <div style="margin:5px;height:15px;width:15px;background-color:#39ae39;" ;>&nbsp;</div>
                            </td>
                            <td><strong><?php echo __('Developed Skill'); ?></strong></td>
                        </tr>
                        <tr>
                            <td>
                                <div style="margin:5px;height:15px;width:15px;background-color:#f79327;" ;>&nbsp;</div>
                            </td>
                            <td><strong><?php echo __('Needs Development'); ?></strong></td>
                        </tr>
                        <tr>
                            <td>
                                <div style="margin:5px;height:15px;width:15px;background-color:#eb1d1d;" ;>&nbsp;</div>
                            </td>
                            <td><strong><?php echo __('Lack of Skill'); ?></strong>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p><br/></td>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($post as $k => $ques):
                            ...
                            ?>
                            <tr <?php if ($ques['ExamStat']['ques_status'] == 'R'){ ?>class="text-success"
                                <?php }elseif ($ques['ExamStat']['ques_status'] == 'W'){ ?>class="text-danger"
                                <?php }else{ ?>class="text-info"<?php } ?>>
