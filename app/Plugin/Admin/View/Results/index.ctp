...
<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Exam Wise'); ?></h1></div>
</div>
<div class="panel">
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <label for="subject_name" class="col-sm-2 control-label">
                <small><?php echo __('Status of Result'); ?></small>
            </label>
            <div class="col-sm-4">
        ...
        <?php if ($isExam) {
            ...
            if (is_array($this->request->data['StudentGroup']['group_name'])) {
                $studentGroup = implode(",", $this->request->data['StudentGroup']['group_name']);
            } ?>
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php foreach ($examResult as $rank => $examValue):
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="label label-<?php if ($examValue['ExamResult']['result'] == "Pass") echo "success"; else echo "danger"; ?>"><?php if ($examValue['ExamResult']['result'] == "Pass") {
                                    echo __('PASSED');
                                } else {
                                    echo __('FAILED');
                                } ?></span></td>
                        <td><?php echo $this->Html->link('<span class="fa fa-arrows-alt"></span>&nbsp; ', array('action' => 'result', $examValue['ExamResult']['id']), array('data-toggle' => 'tooltip', 'title' => __('View Result'), 'escape' => false)); ?>
                            <?php echo $this->Html->link('<span class="fa fa-print"></span>&nbsp; ', array('controller' => '../crm/Results', 'action' => 'printresult', $examValue['ExamResult']['id']), array('data-toggle' => 'tooltip', 'title' => __('Download/Print Result'), 'target' => '_blank', 'escape' => false)); ?>
...
<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Student Wise'); ?></h1></div>
</div>
<div class="panel">
    <div class="panel-body">
        <?php echo $this->Form->create('Result', array('class' => 'form-horizontal')); ?>
        <div class="form-group">
            <label for="subject_name" class="col-sm-3 control-label">
                <small><?php echo __('Name or Enrolment Number'); ?></small>
            </label>
            <div class="col-sm-3">
