...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#QuestionSubjectId').change(function () {
        ...
        $('#QuestionTopicId').change(function () {
            var selectedValue = $(this).val();
            var targeturl = $(this).attr('rel') + '?id=' + selectedValue;
            $.ajax({
                type: 'get',
                ...
                success: function (response) {
                    if (response) {
                        $('#QuestionStopicId').html(response);
                    }
                },
                error: function (e) {
...
<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Question'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div><?php echo $this->Form->input('passage_id', array('type' => 'text', 'class' => 'form-control', 'div' => false, 'label' => __('Passage ID'), 'placeholder' => __('Passage ID if any'), 'autocomplete' => 'off')); ?></div>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="Question">
                    ...
                    <hr/>
                    <?php echo $this->Tinymce->input('question', array('label' => false, 'class' => 'form-control', 'div' => false, 'placeholder' => __('Question')), array('language' => $configLanguage, 'directionality' => $dirType), $editorType); ?>
                </div>
                <div class="tab-pane" id="Answer1">
                    <h4><?php echo __('Option1'); ?></h4>
                    <hr/>
            ...
            <div class="form-group">
                ...
                <?php endforeach;
                unset($groupName); ?>
                <label for="group_name" class="col-sm-1 control-label"><?php echo __('Class'); ?></label>
                <div class="col-sm-5">
                ...
                <div class="col-sm-5">
                    ...
                    echo $this->Form->select('subject_id', $subject_id, array('rel' => $urlSubject, 'empty' => __('Please Select'), 'class' => 'form-control', 'div' => false, 'label' => false)); ?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    <div class="form-group">
                        <label for="group_name" class="col-sm-1 control-label"><?php echo __('Topic'); ?></label>
                        <div class="col-sm-5">
                            <?php $urlTopic = $this->Html->url(array('controller' => 'Questions', 'action' => 'stopic'));
                            echo $this->Form->select('topic_id', $topic, array('rel' => $urlTopic, 'class' => 'form-control', 'empty' => __('Please Select'))); ?>
                        </div>
                        <label for="group_name" class="col-sm-1 control-label"><?php echo __('Sub Topic'); ?></label>
                        <div class="col-sm-5">
                            <?php echo $this->Form->select('stopic_id', $stopic, array('class' => 'form-control', 'empty' => __('Please Select'))); ?>
                        </div>
                    </div>
                </div>
            </div>
