...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#ftb').show();
        <?php }}else{?>$('#qtype_id1').prop('checked', true);<?php }?>
...
<div class="panel"> <?php echo $this->Session->flash(); ?>
    <div class="panel-body">
        <?php echo $this->Form->create('Question', array('name' => 'post_req', 'id' => 'post_req')); ?>
        <div class="col-md-12">
            <div class="row">
                <div><?php echo $this->Form->input('passage_id', array('type' => 'text', 'class' => 'form-control', 'div' => false, 'label' => __('Passage ID'), 'value' => $selPassage, 'placeholder' => __('Passage ID if any'), 'autocomplete' => 'off')); ?></div>
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                echo $this->Form->input('subject_id', array('options' => array($subject_id), 'id' => 'subjectId', 'rel' => $urlSubject, 'empty' => __('Please Select'), 'default' => $selSubject, 'class' => 'form-control', 'div' => false, 'label' => false)); ?>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        echo $this->Form->select('topic_id', $topic, array('id' => 'topicId', 'rel' => $urlTopic, 'required' => true, 'class' => 'form-control', 'empty' => __('Please Select'))); ?>
                    </div>
                    <label for="group_name" class="col-sm-1 control-label"><?php echo __('Sub Topic'); ?></label>
                    <div class="col-sm-5">
                        <?php echo $this->Form->select('stopic_id', $stopic, array('id' => 'stopicId', 'required' => true, 'class' => 'form-control', 'empty' => __('Please Select'))); ?>
                    </div>
                </div>
            </div>
        </div>
