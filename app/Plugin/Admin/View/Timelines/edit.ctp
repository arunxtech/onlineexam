<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Subjects'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Subject as $k => $post): $id = $post['Subject']['id'];
                $form_no = $k + 1; ?>
                    ...
                    <div class="panel-body"><?php echo $this->Session->flash(); ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php endforeach;
                                unset($groupName); ?>
                                <?php echo $this->Form->select("$k.SubjectGroup.group_name", $group_id, array('value' => $gp2, 'multiple' => true, 'label' => false, 'class' => 'form-control multiselectgrp', 'div' => false));
                                $gp2 = array(); ?>
                            </div>
                        </div>
                        <div class="form-group">
