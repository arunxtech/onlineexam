...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Timelines'); ?></h1></div>
    </div>
    <div class="panel">
        <?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Timelines'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Timeline'), array('controller' => 'Timelines', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-success')); ?>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('title', __('Title'), array('direction' => 'asc')); ?></th>
                    ...
                    foreach ($Timeline as $post):
                        ...
                        <tr id="<?php echo $id; ?>">
                            <td><span style="cursor: pointer;"> <i class="fa fa-arrows"></i></span>&nbsp;
                                <?php echo $this->Form->checkbox(false, array('value' => $post['Timeline']['id'], 'name' => 'data[Timeline][id][]', 'id' => "DeleteCheckbox$id", 'class' => 'chkselect')); ?>
                            </td>
                            <td><?php echo $serial_no++; ?></td>
                            <td><?php echo h($post['Timeline']['title']); ?></td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><?php echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add Question'), array('controller' => 'Questions', 'action' => 'add', $post['Timeline']['id']), array('escape' => false)); ?></li>
