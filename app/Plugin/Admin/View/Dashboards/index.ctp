...
<div class="row">
    <div class="col-sm-3">
        <div class="xe-widget xe-counter" data-count=".num" data-from="0" data-to="<?php echo $totalInprogressExam; ?>"
             data-suffix="" data-duration="2">
            <div class="xe-icon"><i class="fa fa-ellipsis-h"></i></div>
            <div class="xe-label"><strong class="num"><?php echo $totalInprogressExam; ?></strong>
                <span><?php echo __('In Progress Exam'); ?></span></div>
        </div>
        <div class="xe-widget xe-counter xe-counter-purple" data-count=".num" data-from="0"
             data-to="<?php echo $totalUpcomingExam; ?>" data-suffix="" data-duration="3" data-easing="false">
            <div class="xe-icon"><i class="fa fa-cloud"></i></div>
            <div class="xe-label"><strong class="num"><?php echo $totalUpcomingExam; ?></strong>
                <span><?php echo __('Upcoming Exam'); ?></span></div>
        </div>
        <div class="xe-widget xe-counter xe-counter-info" data-count=".num" data-from="0"
             data-to="<?php echo $totalCompletedExam; ?>" data-duration="4" data-easing="true">
            <div class="xe-icon"><i class="fa fa-check"></i></div>
            <div class="xe-label"><strong class="num"><?php echo $totalCompletedExam; ?></strong>
                <span><?php echo __('Completed Exam'); ?></span></div>
        </div>
        <div class="xe-widget xe-counter xe-counter-info" data-count=".num" data-from="0"
             data-to="<?php echo $totalStudents; ?>" data-duration="4" data-easing="true">
            <div class="xe-icon"><i class="fa fa-graduation-cap"></i></div>
            <div class="xe-label"><strong class="num"><?php echo $totalStudents; ?></strong>
                <span><?php echo __('Students'); ?></span></div>
        </div>
        <div class="xe-widget xe-counter xe-counter-success" data-count=".num" data-from="0"
             data-to="<?php echo $todaySale; ?>" data-duration="4" data-easing="true">
            <div class="xe-icon"><i class="fa fa-money"></i></div>
            <div class="xe-label"><strong class="num"><?php echo $todaySale; ?></strong>
                <span><?php echo __('Today Sale'); ?></span></div>
        </div>
    </div>
    <div class="col-md-9">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><?php $groupName = $this->Function->showGroupName($post['Group']);
                            echo $groupName; ?></td>
                        <td><?php echo($post['Exam']['total_marks'] / count(explode("|", $groupName))); ?></td>
...
<div class="row">
    <?php echo $this->Form->create('Result', array('url' => array('controller' => 'Results', 'action' => 'index'), 'name' => 'post_req', 'id' => 'post_req')); ?>
    <div class="col-md-12">
        <div class="panel panel-custom">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <?php foreach ($recentExamResult as $recentValue):
                        ...
                        <tr>
                            <td><strong
                                        class="text-danger"><?php echo h($recentValue['RecentExam']['Exam']['name']); ?></strong><br/>
                                <?php echo __('From'); ?>: <strong
                                        class="text-danger"><?php echo $this->Time->format($sysDay . $dateSep . $sysMonth . $dateSep . $sysYear . $dateGap . $sysHour . $timeSep . $sysMin . $dateGap . $sysMer, $recentValue['RecentExam']['Exam']['start_date']); ?></strong><br/>
                                <?php echo __('To'); ?>: <strong
                                        class="text-danger"><?php echo $this->Time->format($sysDay . $dateSep . $sysMonth . $dateSep . $sysYear . $dateGap . $sysHour . $timeSep . $sysMin . $dateGap . $sysMer, $recentValue['RecentExam']['Exam']['end_date']); ?></strong><br/>
    ...
    echo $this->Form->hidden('examWise');
    echo $this->Form->hidden('status');
    echo $this->Form->hidden('StudentGroup.group_name'); ?>
    <?php echo $this->Form->end(null); ?>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-custom">
            <div class="panel-heading"><?php echo __('Top 10 Student Class Wise'); ?></div>
            <div class="table-responsive">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($Subject as $sd): ?>
                        <tr>
                            <td><?php echo h($subject_name = $sd['Subject']['subject_name']); ?></td>
