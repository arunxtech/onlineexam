<div class="panel panel-custom">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Smssetting', array('url' => array('action' => 'index'), 'type' => 'post', 'class' => 'form-horizontal')); ?>
        ...
        <div class="form-group">
            ...
            <label for="site_name"
                   class="col-sm-offset-1 col-sm-5 control-label"><?php echo('e.g: channel=Trans&DCS=0&flashsms=0&route=2'); ?></label>
        </div>
        <div class="form-group text-left">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-success"><span
                            class="fa fa-refresh"></span>&nbsp;<?php echo __('Save Settings'); ?></button>
            </div>
        </div>
