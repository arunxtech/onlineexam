                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><?php echo $this->Html->link('<span class="fa fa-server"></span>&nbsp;' . __('Used Coupons'), array('controller' => 'CouponsStudents', 'action' => 'index', 'name' => $post['Coupon']['name']), array('escape' => false)); ?></li>
