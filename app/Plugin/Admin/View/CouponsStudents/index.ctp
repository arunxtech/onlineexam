    ...
    <div class="panel">
        ...
        <div class="panel-heading">
            ...
            <div class="row mrg">
                ...
                <div class="col-md-3">
                    <button type="button" id="searchbtn" class="btn btn-success"><span class="fa fa-search"></span>
                        Search
                    </button>
                    <?php echo $this->Html->link('<span class="fa fa-refresh"></span>&nbsp;Reset', array('action' => 'index', $couponId), array('class' => 'btn btn-warning', 'escape' => false)); ?>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('used_date', __('Used Date'), array('direction' => 'asc')); ?></th>
                    </tr>
                    <?php foreach ($CouponsStudent as $post):
                        ...
                        <tr>
                            ...
                            <td><?php if ($post['CouponsStudent']['redeem_date'] != null) {
                                    echo $this->Time->format($dtmFormat, $post['CouponsStudent']['redeem_date']);
                                } ?></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php unset($post); ?>
