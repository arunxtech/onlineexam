                            ...
                            foreach ($language as $languageIndex => $item) {
                                ...
                                <div class="form-group">
                                    <label for="group_name"
                                           class="col-sm-3 control-label"><?php echo $language; ?></label>
                                    <div class="col-sm-9">
                                        <?php echo $this->Tinymce->input("$k.Passage.passage_$languageId", array('value' => $passageArr[$languageIndex], 'label' => false, 'class' => 'form-control', 'placeholder' => __('Passage in %s', $language), 'div' => false), array('language' => $configLanguage, 'directionality' => $dirType), 'full'); ?>
                                    </div>
                                </div>
                                <?php
                            } ?>
