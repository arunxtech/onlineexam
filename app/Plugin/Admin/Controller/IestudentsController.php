...
class IestudentsController extends AdminAppController
{
        ...
        try {
            if ($this->request->is('post')) {
                if (is_array($this->request->data['StudentGroup']['group_name'])) {
                    ...
                    $this->Session->setFlash(__('Please Select Class'), 'flash', array('alert' => 'danger'));
                    return $this->redirect(array('action' => 'index'));
                }
            }
        } catch (Exception $e) {
    ...
    {
        $showData = array(array(__('Name'), __('Email'), __('Password'), __('Phone'), __('Enrolment Number'), __('Alternate Number'), __('Address'), __('Expiry Days'), __('Admission Date'), __('Status'), __('ID'), __('Class')));
