...
class MailsController extends AdminAppController
{
    ...
    public function beforeFilter()
    {
        parent::beforeFilter();
        $this->authenticate();
        $this->mailType = $this->adminValue['User']['name'];
    }
    ...
    public function studentsearch()
    {
        ...
        $users = $this->Student->find('all', array('joins' => array(array('table' => 'student_groups', 'alias' => 'StudentGroup', 'type' => 'INNER', 'conditions' => array('Student.id=StudentGroup.student_id'))),
            'conditions' => array('Student.email LIKE' => '%' . $term . '%', "StudentGroup.group_id IN($this->userGroupWiseId)"),
