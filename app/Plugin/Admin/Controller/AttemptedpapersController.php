        ...
        try {
            if ($this->emailNotification || $this->smsNotification) {
                ...
                foreach ($post as $value) {
                    ...
                    $result = $value['ExamResult']['result'];
                    $obtainedMarks = $value['ExamResult']['obtained_marks'];
                    $questionAttempt = $value['ExamResult']['total_answered'];
                    $timeTaken = $this->CustomFunction->secondsToWords(CakeTime::fromString($value['ExamResult']['end_time']) - CakeTime::fromString($value['ExamResult']['start_time']));
