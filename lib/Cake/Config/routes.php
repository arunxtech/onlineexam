...
Router::connect('/api/student/login', array('controller' => 'Users', 'action' => 'api_login',  'isRest' => true));
Router::connect('/api/student/edit-profile', array('controller' => 'Profiles', 'action' => 'api_editProfile',  'isRest' => true)); 
Router::connect('/api/student/timeline', array('controller' => 'Timelines', 'action' => 'api_get_timelines',  'isRest' => true));
Router::connect('/api/student/exam', array('controller' => 'Exams', 'action' => 'api_free_exam',  'isRest' => true)); 
Router::connect('/api/student/upcoming-exam', array('controller' => 'Exams', 'action' => 'api_upcoming_exam',  'isRest' => true)); 
...
/*teacher*/
Router::connect('/api/teacher/login', array('controller' => 'Users', 'action' => 'api_login',  'isRest' => true));
